...
import cn.darkjrong.aliyun.oss.api.impl.BucketApiImpl;
import cn.darkjrong.aliyun.oss.api.impl.FileOperationsApiImpl;
import cn.darkjrong.aliyun.oss.api.impl.PresignedUrlApiImpl;
...
public class FileOperationsApiTest extends BaseApiTest {
    ...
    private static FileOperationsApiImpl fileOperationsApi;
    static {
        PresignedUrlApiImpl presignedUrlApi = new PresignedUrlApiImpl(ossClient, aliyunOSSProperties);
        BucketApiImpl bucketApi = new BucketApiImpl(ossClient, presignedUrlApi);
        fileOperationsApi = new FileOperationsApiImpl(ossClient, presignedUrlApi, bucketApi);
    }
