...
public interface FileOperationsApi {
     ...
     */
    FileInfo uploadFile(String bucketName, String directory, File file, Map<String, String> tags) throws AliyunOssClientException;
     ...
     * @throws AliyunOssClientException 文件上传异常
     */
    FileInfo uploadFile(String bucketName, String directory, byte[] bytes, Map<String, String> tags) throws AliyunOssClientException;
     ...
     * @throws AliyunOssClientException 文件上传异常
     */
    FileInfo uploadFile(String bucketName, String directory, InputStream inputStream, String extName, Map<String, String> tags) throws AliyunOssClientException;
     ...
     * @throws AliyunOssClientException 文件上传异常
     */
    FileInfo uploadFile(String bucketName, String directory, InputStream inputStream, Map<String, String> tags) throws AliyunOssClientException;
     ...
     * @throws AliyunOssClientException 文件上传异常
     */
    FileInfo shardUploadFile(String bucketName, String directory, File file, Map<String, String> tags) throws AliyunOssClientException;
     ...
     * @throws AliyunOssClientException 文件上传异常
     */
    FileInfo shardUploadFile(String bucketName, String directory, File file, Long partSize, Map<String, String> tags) throws AliyunOssClientException;
     ...
     * @throws AliyunOssClientException 文件上传异常
     */
    FileInfo uploadFile(String bucketName, String directory, File file, Map<String, String> tags, ProgressCallBack progressCallBack) throws AliyunOssClientException;
     ...
     * @throws AliyunOssClientException 操作异常
     */
    Map<String, String> getObjectTagging(String bucketName, String objectName) throws AliyunOssClientException;
     ...
     * @throws AliyunOssClientException 操作异常
     */
    FileInfo speedLimitUploadFile(String bucketName, String directory, File file, Integer limitSpeed, Map<String, String> tags) throws AliyunOssClientException;
     ...
     * @throws AliyunOssClientException 操作异常
     */
    FileInfo speedLimitUploadFile(String bucketName, String directory, byte[] bytes, Integer limitSpeed, Map<String, String> tags) throws AliyunOssClientException;
     ...
     * @throws AliyunOssClientException 操作异常
     */
    FileInfo speedLimitUploadFile(String bucketName, String directory, InputStream inputStream, Integer limitSpeed, Map<String, String> tags) throws AliyunOssClientException;
     ...
     * @throws AliyunOssClientException 操作异常
     */
    FileInfo speedLimitUploadFile(String bucketName, String directory, byte[] bytes, Integer limitSpeed, Map<String, String> tags, String extName) throws AliyunOssClientException;
     ...
     * @throws AliyunOssClientException 操作异常
     */
    FileInfo speedLimitUploadFile(String bucketName, String directory, InputStream inputStream, Integer limitSpeed, Map<String, String> tags, String extName) throws AliyunOssClientException;
     ...
     * @throws AliyunOssClientException 操作异常
     */
    FileInfo speedLimitUploadFile(String bucketName, String directory, File file, Map<String, String> tags) throws AliyunOssClientException;
     ...
     * @throws AliyunOssClientException 操作异常
     */
    FileInfo speedLimitUploadFile(String bucketName, String directory, byte[] bytes, Map<String, String> tags) throws AliyunOssClientException;
     ...
     * @throws AliyunOssClientException 操作异常
     */
    FileInfo speedLimitUploadFile(String bucketName, String directory, InputStream inputStream, Map<String, String> tags) throws AliyunOssClientException;
     ...
     * @throws AliyunOssClientException 操作异常
     */
    FileInfo speedLimitUploadFile(String bucketName, String directory, byte[] bytes, Map<String, String> tags, String extName) throws AliyunOssClientException;
     ...
     * @throws AliyunOssClientException 操作异常
     */
    FileInfo speedLimitUploadFile(String bucketName, String directory, InputStream inputStream, Map<String, String> tags, String extName) throws AliyunOssClientException;
