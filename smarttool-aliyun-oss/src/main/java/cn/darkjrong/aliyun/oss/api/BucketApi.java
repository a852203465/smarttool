...
public interface BucketApi {
     ...
     * 设置Bucket 授权策略
     * @param bucketName  存储空间
     * @param bucketPolicyParam 授权策略
     * @return 是否成功， true: 成功，false: 不成功
     */
    boolean setBucketPolicy(String bucketName, BucketPolicyParam bucketPolicyParam);
     ...
     * @throws AliyunOssClientException 操作异常
     */
    BucketPolicyInfo getBucketPolicy(String bucketName) throws AliyunOssClientException;
     ...
     * @throws AliyunOssClientException 操作异常
     */
    GetBucketInventoryConfigurationResult getBucketInventoryConfiguration(String bucketName, String inventoryId) throws AliyunOssClientException;
     ...
     * 查询存储空间的生命周期规则
     * @param bucketName 存储空间
     * @return 生命周期规则信息 不存在/未设置
     * @throws AliyunOssClientException 异常异常
     */
    List<LifecycleRule> getBucketLifecycle(String bucketName) throws AliyunOssClientException;
     ...
     * @throws AliyunOssClientException 操作异常
     */
    List<String> getBucketReplicationLocation(String bucketName) throws AliyunOssClientException;
     ...
     * @throws AliyunOssClientException 操作异常
     */
    String getBucketVersioning(String bucketName) throws AliyunOssClientException;
