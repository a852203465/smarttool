...
public class MinioTemplate {
    ...
    public Boolean bucketExists(String bucketName) {
        ...
        MinioUtils.notEmpty(bucketName, ErrorEnum.BUCKET_NAME_CANNOT_BE_EMPTY);
        ...
        try {
            ...
            log.error(String.format("判断bucket是否存在异常,【%s】", e.getMessage()), e);
        }
    ...
    public StatObjectResponse statObject(String bucketName, String objectName) throws MinioException {
        MinioUtils.notEmpty(bucketName, ErrorEnum.BUCKET_NAME_CANNOT_BE_EMPTY);
        MinioUtils.notEmpty(objectName, ErrorEnum.OBJECT_NAME_CANNOT_BE_EMPTY);
    ...
    public StatObjectResponse statObject(String bucketName, String objectName, String versionId) throws MinioException {
        ...
        try {
            ...
            log.error(String.format("获取对象信息异常,【%s】", e.getMessage()), e);
    ...
    public byte[] getObject(String bucketName, String objectName) throws MinioException {
        ...
        try {
            ...
            log.error(String.format("获取对象异常,【%s】", e.getMessage()), e);
            throw new MinioException(e);
        }
    }
    ...
    public void downloadObject(String bucketName, String objectName, String fileName) throws MinioException {
        ...
        MinioUtils.notEmpty(bucketName, ErrorEnum.BUCKET_NAME_CANNOT_BE_EMPTY);
        MinioUtils.notEmpty(objectName, ErrorEnum.OBJECT_NAME_CANNOT_BE_EMPTY);
        MinioUtils.notEmpty(fileName, ErrorEnum.FILE_NAME_CANNOT_BE_EMPTY);
        ...
        try {
            ...
            log.error(String.format("下载对象异常,【%s】", e.getMessage()), e);
            throw new MinioException(e);
        }
    }
    ...
    public String copyObject(String srcBucketName, String targetBucketName,
        ...
        MinioUtils.notEmpty(srcBucketName, ErrorEnum.SOURCE_BUCKET_CANNOT_BE_EMPTY);
        MinioUtils.notEmpty(targetBucketName, ErrorEnum.TARGET_BUCKET_CANNOT_BE_EMPTY);
        MinioUtils.notEmpty(srcObjectName, ErrorEnum.SOURCE_OBJECT_CANNOT_BE_EMPTY);
        MinioUtils.notEmpty(targetObjectName, ErrorEnum.TARGET_OBJECT_CANNOT_BE_EMPTY);
        ...
        try {
            ...
            log.error(String.format("复制对象异常,【%s】", e.getMessage()), e);
            throw new MinioException(e);
        }
    }
    ...
    public String getObjectUrl(String bucketName, String objectName, int duration, TimeUnit unit) throws MinioException {
        ...
        try {
            ...
            log.error(String.format("获取对象URL异常,【%s】", e.getMessage()), e);
            throw new MinioException(e);
        }
    }
    ...
    public Boolean removeObject(String bucketName, String objectName, String versionId) {
        ...
        try {
            ...
            log.error(String.format("删除对象异常,【%s】", e.getMessage()), e);
        }
        return Boolean.FALSE;
    }
    ...
    public List<RemoveObject> removeObject(List<RemoveObject> removeObjects) {
        ...
        MinioUtils.notEmpty(removeObjects, ErrorEnum.THE_OBJECT_COLLECTION_CANNOT_BE_EMPTY);
    ...
    public List<Bucket> listBuckets() throws MinioException {
        ...
        try {
            ...
            log.error(String.format("获取bucket集合异常,【%s】", e.getMessage()), e);
            throw new MinioException(e);
        }
    }
    ...
    public Boolean makeBucket(String bucketName, boolean objectLock) {
        ...
        try {
            ...
            log.error(String.format("创建bucket异常,【%s】", e.getMessage()), e);
        }
    ...
    public Boolean setBucketVersion(String bucketName,
        ...
        try {
            ...
            log.error(String.format("设置bucket版本异常,【%s】", e.getMessage()), e);
        }
    ...
    public VersioningConfiguration getBucketVersion(String bucketName) throws MinioException {
        ...
        try {
            ...
            log.error(String.format("获取bucket版本异常,【%s】", e.getMessage()), e);
            throw new MinioException(e);
        }
    }
    ...
    public Boolean setObjectLockConfiguration(String bucketName, RetentionMode retentionMode, int duration, boolean isDays) {
        ...
        try {
            ...
            log.error(String.format("设置对象锁配置异常,【%s】", e.getMessage()), e);
        }
        return Boolean.FALSE;
    }
    ...
    public Boolean deleteObjectLockConfiguration(String bucketName) {
        ...
        try {
            ...
            log.error(String.format("删除对象锁配置异常,【%s】", e.getMessage()), e);
        }
        return Boolean.FALSE;
    }
    ...
    public ObjectLockConfiguration getObjectLockConfiguration(String bucketName) throws MinioException {
        ...
        try {
            ...
            log.error(String.format("获取对象锁配置异常,【%s】", e.getMessage()), e);
            throw new MinioException(e);
        }
    }
    ...
    public Boolean setObjectRetention(String bucketName, String objectName, RetentionMode retentionMode, ZonedDateTime zonedDateTime, boolean bypassGovernanceMode) {
        ...
        try {
            ...
            log.error(String.format("设置对象保留时间异常,【%s】", e.getMessage()), e);
        }
        return Boolean.FALSE;
    }
    ...
    public Retention getObjectRetention(String bucketName, String objectName) throws MinioException {
        ...
        try {
            ...
            log.error(String.format("获取对象保留信息异常,【%s】", e.getMessage()), e);
            throw new MinioException(e);
        }
    }
    ...
    public Boolean enableObjectLegalHold(String bucketName, String objectName) {
        ...
        try {
            ...
            log.error(String.format("enableObjectLegalHold,【%s】", e.getMessage()), e);
        }
    ...
    public Boolean disableObjectLegalHold(String bucketName, String objectName) {
        ...
        try {
            ...
            log.error(String.format("disableObjectLegalHold,【%s】", e.getMessage()), e);
        }
        return Boolean.FALSE;
    }
    ...
    public Boolean isObjectLegalHoldEnabled(String bucketName, String objectName) {
        ...
        try {
            ...
            log.error(String.format("isObjectLegalHoldEnabled,【%s】", e.getMessage()), e);
        }
        return Boolean.FALSE;
    }
    ...
    public Boolean removeBucket(String bucketName) {
        ...
        try {
            ...
            log.error(String.format("删除bucket异常,【%s】", e.getMessage()), e);
        }
        return Boolean.FALSE;
    }
    ...
    public String putObject(String bucketName, String baseDir, String objectName, InputStream file, String contentType) throws MinioException {
        MinioUtils.notEmpty(bucketName, ErrorEnum.BUCKET_NAME_CANNOT_BE_EMPTY);
        MinioUtils.notEmpty(objectName, ErrorEnum.OBJECT_NAME_CANNOT_BE_EMPTY);
        MinioUtils.notEmpty(file, ErrorEnum.FILE_NAME_CANNOT_BE_EMPTY);
        ...
        try {
            ...
            log.error(String.format("bucket【%s】对象【%s】上传异常,【%s】", bucketName, objectName, e.getMessage()), e);
            throw new MinioException(e);
        }finally {
            IoUtil.close(file);
        }
    ...
    public String putObject(String bucketName, String baseDir, String objectName, MultipartFile file) throws MinioException {
        Assert.isFalse(file.isEmpty(), ErrorEnum.FILE_NAME_CANNOT_BE_EMPTY.getMessage());
        try {
            return this.putObject(bucketName, baseDir, objectName, file.getInputStream(), null);
        }catch (IOException e) {
            log.error(String.format("bucket【%s】对象【%s】上传对象异常,【%s】", bucketName, objectName, e.getMessage()), e);
            throw new MinioException(e);
        }
    }
    ...
    public String putObject(String bucketName, String baseDir, String objectName, File file, String contentType) throws MinioException {
        MinioUtils.notEmpty(bucketName, ErrorEnum.BUCKET_NAME_CANNOT_BE_EMPTY);
        MinioUtils.notEmpty(objectName, ErrorEnum.OBJECT_NAME_CANNOT_BE_EMPTY);
        Assert.isTrue(FileUtil.exist(file), ErrorEnum.FILE_NAME_CANNOT_BE_EMPTY.getMessage());
        baseDir = StrUtil.isBlank(baseDir) ? StrUtil.EMPTY
                : StrUtil.endWith(baseDir, StrUtil.SLASH) ? baseDir : baseDir + StrUtil.SLASH;
        objectName = baseDir + MinioUtils.getDateFolder() + StrUtil.SLASH + objectName;
        try {
    ...
    public String getBucketPolicy(String bucketName) throws MinioException {
        Assert.notBlank(bucketName, ErrorEnum.BUCKET_NAME_CANNOT_BE_EMPTY.getMessage());
        ...
        try {
            ...
            log.error(String.format("bucket【%s】获取bucket策略异常,【%s】", bucketName, e.getMessage()), e);
            throw new MinioException(e);
        }
    }
    ...
    public Boolean setBucketPolicy(String bucketName, BucketPolicyParam bucketPolicyParam) {
        ...
        try {
            ...
            log.error(String.format("bucket【%s】设置bucket策略【%s】异常,【%s】", bucketName, JSON.toJSONString(bucketPolicyParam), e.getMessage()), e);
        }
        return Boolean.FALSE;
    }
    ...
    public Boolean deleteBucketPolicy(String bucketName) {
        ...
        try {
            ...
            log.error(String.format("bucket【%s】删除策略异常,【%s】", bucketName, e.getMessage()), e);
        }
        return Boolean.FALSE;
    }
    ...
    public Boolean setBucketLifecycle(String bucketName, List<LifecycleRule> rules) {
        ...
        try {
            ...
            log.error(String.format("bucket【%s】设置生命周期异常,【%s】", bucketName, e.getMessage()), e);
        }
    ...
    public NotificationConfiguration getBucketNotification(String bucketName) throws MinioException {
        ...
        try {
            ...
            log.error(String.format("bucket【%s】获取通知异常,【%s】", bucketName, e.getMessage()), e);
            throw new MinioException(e);
        }
    }
    ...
    public Boolean setBucketNotification(String bucketName, List<QueueConfiguration> queueConfigurations) {
        ...
        try {
            ...
            log.error(String.format("bucket【%s】设置通知异常,【%s】", bucketName, e.getMessage()), e);
        }
        return Boolean.FALSE;
    }
    ...
    public Boolean deleteBucketNotification(String bucketName) {
        ...
        try {
            ...
            log.error(String.format("bucket【%s】删除通知异常,【%s】", bucketName, e.getMessage()), e);
        }
        return Boolean.FALSE;
    }
    ...
    public ReplicationConfiguration getBucketReplication(String bucketName) throws MinioException {
        ...
        try {
            ...
            log.error(String.format("bucket【%s】获取复制配置异常,【%s】", bucketName, e.getMessage()), e);
            throw new MinioException(e);
        }
    }
    ...
    public Boolean setBucketReplication(String bucketName, List<ReplicationRule> rules) {
        ...
        try {
            ...
            log.error(String.format("bucket【%s】设置复制配置异常,【%s】", bucketName, e.getMessage()), e);
        }
        return Boolean.FALSE;
    }
    ...
    public Boolean deleteBucketReplication(String bucketName) {
        ...
        try {
            ...
            log.error(String.format("bucket【%s】删除复制配置异常,【%s】", bucketName, e.getMessage()), e);
        }
        return Boolean.FALSE;
    }
    ...
    public List<NotificationRecords> listenBucketNotification(String bucketName, String prefix, String suffix, String[] events) throws MinioException {
        ...
        try {
            ...
            log.error(String.format("bucket【%s】监听对象通知异常,【%s】", bucketName, e.getMessage()), e);
            throw new MinioException(e);
        }
    }
    ...
    public Boolean setBucketEncryption(String bucketName, SseAlgorithm sseAlgorithm) {
        ...
        try {
            ...
            log.error(String.format("bucket【%s】设置加密异常,【%s】", bucketName, e.getMessage()), e);
        }
        return Boolean.FALSE;
    }
    ...
    public SseConfigurationRule getBucketEncryption(String bucketName) throws MinioException {
        ...
        try {
            ...
            log.error(String.format("bucket【%s】获取加密异常,【%s】", bucketName, e.getMessage()), e);
            throw new MinioException(e);
        }
    }
    ...
    public Boolean deleteBucketEncryption(String bucketName) {
        ...
        try {
            ...
            log.error(String.format("bucket【%s】删除加密异常,【%s】", bucketName, e.getMessage()), e);
        }
        return Boolean.FALSE;
    }
    ...
    public Map<String, String> getBucketTags(String bucketName) throws MinioException{
        ...
        try {
            ...
            log.error(String.format("bucket【%s】获取标签异常,【%s】", bucketName, e.getMessage()), e);
            throw new MinioException(e);
        }
    }
    ...
    public Boolean setBucketTags(String bucketName, Map<String, String> tags) {
        ...
        try {
            ...
            log.error(String.format("bucket【%s】设置标签异常,【%s】", bucketName, e.getMessage()), e);
        }
        return Boolean.FALSE;
    }
    ...
    public Boolean deleteBucketTags(String bucketName) {
        ...
        try {
            ...
            log.error(String.format("bucket【%s】删除标签异常,【%s】", bucketName, e.getMessage()), e);
        }
        return Boolean.FALSE;
    }
    ...
    public Map<String, String> getObjectTags(String bucketName, String objectName) throws MinioException {
        Assert.notBlank(objectName, ErrorEnum.OBJECT_NAME_CANNOT_BE_EMPTY.getMessage());
        Assert.notBlank(bucketName, ErrorEnum.BUCKET_NAME_CANNOT_BE_EMPTY.getMessage());
        ...
        try {
            ...
            log.error(String.format("bucket【%s】object【%s】获取对象标签异常,【%s】", bucketName, objectName, e.getMessage()), e);
            throw new MinioException(e);
        }
    ...
    public Boolean setObjectTags(String bucketName, String objectName, Map<String, String> tags) {
        ...
        try {
            ...
            log.error(String.format("bucket【%s】object【%s】设置对象标签异常,【%s】", bucketName, objectName, e.getMessage()), e);
        }
        return Boolean.FALSE;
    }
    ...
    public Boolean deleteObjectTags(String bucketName, String objectName) {
        ...
        try {
            ...
            log.error(String.format("bucket【%s】object【%s】删除对象标签异常,【%s】", bucketName, objectName, e.getMessage()), e);
        }
        return Boolean.FALSE;
    }
    ...
    public Boolean deleteObjectTags( String objectName) {
        ...
        try {
            ...
            log.error(String.format("bucket【%s】object【%s】删除对象标签异常,【%s】", minioProperties.getBucketName(), objectName, e.getMessage()), e);
        }
        return Boolean.FALSE;
    }
